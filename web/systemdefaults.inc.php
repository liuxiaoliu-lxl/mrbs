...
$mrbs_company = "IDG MRBS";   // This line must always be uncommented ($mrbs_company is used in various places)
...
$strftime_format['weekview_headers']   = "%b%e<span>%a</span>";  // Used in the table header in Month view (all rooms)
